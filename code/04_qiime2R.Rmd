...
saveRDS(alph_tilp, file = here("data/intermediate/qiime2R/tilapia/alpha_diversity.rds"))

# Beta-diversity: distance metric
saveRDS(dist_tilp, file = here("data/intermediate/qiime2R/tilapia/beta_diversity_distance.rds"))

# Beta-diversity: ordination
saveRDS(ord_tilp, file = here("data/intermediate/qiime2R/tilapia/beta_diversity_ordination.rds"))
```
