...
plot_betadisper(
  ...
  xlab = "Site",
  title = "Multivariate dispersion: Site-level (farmed tilapia)") +
  coord_flip()
```
...
plot_betadisper(
  ...
  xlab = "Environment",
  title = "Multivariate dispersion: Environment-level (farmed tilapia)") 
```
...
plot_betadisper(
  disp_atch_lake_site, 
  xlab = "Site",
  title = "Multivariate dispersion: Site-level (tilapia in lake)") +
  coord_flip()
```
...
plot_betadisper(
  disp_atch_lake_pop, 
  xlab = "Population",
  title = "Multivariate dispersion: Population-level (tilapia in lake)") 
```
...
As PERMANOVA suggests little evidence of Site effect, here we use individual sample for assessing homogeneity of multivariate dispersion at population-level.
